...
import com.u3coding.audiovideo.opengl.BaseGLSL.createOpenGLProgram
 ...
 */
class ImageRenderer(private val mContext: Context) :
    ...
    override fun onDrawFrame(gl: GL10) {
        GLES20.glClear(GLES20.GL_COLOR_BUFFER_BIT or GLES20.GL_DEPTH_BUFFER_BIT) //表示要清除颜色缓冲以及深度缓冲
    ...
    init {
        mBitmap =
            BitmapFactory.decodeStream(mContext.resources.assets.open("fengjing.png"))
        val bb =
            ByteBuffer.allocateDirect(sPos.size * 4) //为存放形状的坐标，初始化顶点字节缓冲,float占4个字节
